package controls
{
   ...
   public class TankInputL extends Sprite
   {
      ...
      private function draw() : void
      {
         ...
         _loc1_.clear();
         _loc1_.beginBitmapFill(this._valide ? (this._locked ? this.bmpLeftO : this.bmpLeft) : this.bmpLeftWrong);
         ...
         _loc1_.clear();
         _loc1_.beginBitmapFill(this._valide ? (this._locked ? this.bmpCenterO : this.bmpCenter) : this.bmpCenterWrong);
         ...
         _loc1_.clear();
         _loc1_.beginBitmapFill(this._valide ? (this._locked ? this.bmpRightO : this.bmpRight) : this.bmpRightWrong);
         _loc1_.drawRect(0,0,5,30);
         _loc1_.endFill();
