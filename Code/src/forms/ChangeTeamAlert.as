package forms
{
   ...
   public class ChangeTeamAlert extends Sprite
   {
      ...
      {
         super();
         var _loc3_:String = param2 == RED ? localeService.getText(TanksLocale.TEXT_BATTLE_TEAM_RED) : localeService.getText(TanksLocale.TEXT_BATTLE_TEAM_BLUE);
         this.label.align = TextFormatAlign.CENTER;
         this.label.size = 14;
         this.label.bold = true;
         this.label.htmlText = "<font color=" + (param2 == RED ? "\"#ff9999\">" : "\"#99ccff\">") + localeService.getText(TanksLocale.TEXT_BATTLE_TEAM_ALERT,_loc3_) + "</font>";
         addChild(this.bg);
         addChild(this.label);
