package scpacker.networking.protocol.packets.captcha
{
   ...
   public class RequestCaptchaOutPacket extends AbstractPacket
   {
      public static const id:int = -349828108;
      
      public var location:CaptchaLocation;
      
      public function RequestCaptchaOutPacket(param1:CaptchaLocation = null)
      {
         super();
      ...
      {
         return new RequestCaptchaOutPacket();
      }
