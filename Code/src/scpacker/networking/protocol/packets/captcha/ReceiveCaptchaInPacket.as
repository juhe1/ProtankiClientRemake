package scpacker.networking.protocol.packets.captcha
{
   ...
   public class ReceiveCaptchaInPacket extends AbstractPacket
   {
      public static const id:int = -1670408519;
      
      public var location:CaptchaLocation;
      
      public var imageData:Vector.<int>;
      
      public function ReceiveCaptchaInPacket(param1:CaptchaLocation = null, param2:Vector.<int> = null)
      {
         super();
      ...
      {
         return new ReceiveCaptchaInPacket();
      }
