package scpacker.networking.protocol.packets.bonusregion
{
   ...
   public class ShowDropZoneInPacket extends AbstractPacket
   {
      public static const id:int = -915079427;

      public var bonusRegion:BonusRegionData;
      
      public function ShowDropZoneInPacket(param1:BonusRegionData = null)
      {
         super();
      ...
      {
         return new ShowDropZoneInPacket();
      }
