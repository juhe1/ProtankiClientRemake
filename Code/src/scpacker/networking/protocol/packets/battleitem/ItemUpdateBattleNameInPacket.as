package scpacker.networking.protocol.packets.battleitem
{
   ...
   public class ItemUpdateBattleNameInPacket extends AbstractPacket
   {
      ...
      public function ItemUpdateBattleNameInPacket(param1:String = "", param2:String = "")
      {
         super();
      ...
      {
         return new ItemUpdateBattleNameInPacket();
      }
