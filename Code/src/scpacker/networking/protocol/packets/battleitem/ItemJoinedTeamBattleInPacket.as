package scpacker.networking.protocol.packets.battleitem
{
   ...
   public class ItemJoinedTeamBattleInPacket extends AbstractPacket
   {
      ...
      public function ItemJoinedTeamBattleInPacket(param1:String = "", param2:String = "", param3:BattleTeam = null)
      {
         super();
      ...
      {
         return new ItemJoinedTeamBattleInPacket();
      }
