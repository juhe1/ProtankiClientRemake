package scpacker.networking.protocol.packets.battleitem
{
   ...
   public class UpdateBattleSuspicionInPacket extends AbstractPacket
   {
      ...
      public function UpdateBattleSuspicionInPacket(param1:String = "", param2:BattleSuspicionLevel = null)
      {
         super();
      ...
      {
         return new UpdateBattleSuspicionInPacket();
      }
