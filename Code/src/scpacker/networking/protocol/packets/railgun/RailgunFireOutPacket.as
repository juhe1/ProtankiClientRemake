package scpacker.networking.protocol.packets.railgun
{
   ...
   public class RailgunFireOutPacket extends AbstractPacket
   {
      public static const id:int = -484994657;
      ...
      public function RailgunFireOutPacket(param1:int = 0, param2:Vector3d = null, param3:Vector.<String> = null, param4:Vector.<Vector3d> = null, param5:Vector.<int> = null, param6:Vector.<Vector3d> = null, param7:Vector.<Vector3d> = null)
      {
         super();
         this.time = param1;
      ...
      {
         return new RailgunFireOutPacket();
      }
