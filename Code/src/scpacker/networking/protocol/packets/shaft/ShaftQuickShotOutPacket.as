package scpacker.networking.protocol.packets.shaft
{
   ...
   public class ShaftQuickShotOutPacket extends AbstractPacket
   {
      public static const id:int = -2030760866;
      ...
      public function ShaftQuickShotOutPacket(param1:int = 0, param2:Vector3d = null, param3:Vector.<String> = null, param4:Vector.<Vector3d> = null, param5:Vector.<int> = null, param6:Vector.<Vector3d> = null, param7:Vector.<Vector3d> = null)
      {
         super();
      ...
      {
         return new ShaftQuickShotOutPacket();
      }
