package scpacker.networking.protocol.packets.registration
{
   ...
   public class CreateAccountOutPacket extends AbstractPacket
   {
      public static const id:int = 427083290;
      ...
      public function CreateAccountOutPacket(param1:String = "", param2:String = "", param3:Boolean = false)
      {
         super();
      ...
      {
         return new CreateAccountOutPacket();
      }
