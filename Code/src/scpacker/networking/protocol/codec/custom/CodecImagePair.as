package scpacker.networking.protocol.codec.custom
{
   ...
   public class CodecImagePair implements ICodec
   {
      ...
      public function CodecImagePair(param1:ProtocolInitializer)
      {
         super();
         this.newname_4337__END = param1.getCodec("scpacker.networking.protocol.codec.primitive.StringCodec");
         this.newname_4338__END = param1.getCodec("scpacker.networking.protocol.codec.complex.ByteArrayCodec");
      }
      ...
      public function decode(param1:ByteArray) : Object
      {
         ...
         _loc2_.value = this.newname_4338__END.decode(param1) as ByteArray;
         return _loc2_;
      }
