   ...
   public class DESKey implements ISymmetricKey
   {
      ...
      protected function generateWorkingKey(param1:Boolean, param2:ByteArray, param3:uint) : Array
      {
         ...
         while(_loc9_ < 16)
         {
            ...
            while(_loc8_ < 24)
            {
               if(Boolean(_loc6_[pc2[_loc8_]]))
               {
                  _loc4_[_loc10_] |= bigbyte[_loc8_];
               }
               if(Boolean(_loc6_[pc2[_loc8_ + 24]]))
               {
      ...
      protected function desFunc(param1:Array, param2:ByteArray, param3:uint, param4:ByteArray, param5:uint) : void
      {
         ...
         _loc8_ |= (param2[param3 + 1] & 0xFF) << 16;
         _loc8_ |= (param2[param3 + 2] & 0xFF) << 8;
         _loc8_ |= param2[param3 + 3] & 0xFF;
         _loc7_ = uint((param2[param3 + 4] & 0xFF) << 24);
         _loc7_ |= (param2[param3 + 5] & 0xFF) << 16;
         _loc7_ |= (param2[param3 + 6] & 0xFF) << 8;
         _loc7_ |= param2[param3 + 7] & 0xFF;
         ...
         while(_loc9_ < 8)
         {
            ...
            _loc6_ ^= param1[_loc9_ * 4 + 0];
            _loc10_ = uint(SP7[_loc6_ & 0x3F]);
            _loc10_ |= SP5[_loc6_ >>> 8 & 0x3F];
            _loc10_ |= SP3[_loc6_ >>> 16 & 0x3F];
            _loc10_ |= SP1[_loc6_ >>> 24 & 0x3F];
            _loc6_ = uint(_loc7_ ^ param1[_loc9_ * 4 + 1]);
            _loc10_ |= SP8[_loc6_ & 0x3F];
            _loc10_ |= SP6[_loc6_ >>> 8 & 0x3F];
            _loc10_ |= SP4[_loc6_ >>> 16 & 0x3F];
            _loc10_ |= SP2[_loc6_ >>> 24 & 0x3F];
            _loc8_ ^= _loc10_;
            _loc6_ = uint(_loc8_ << 28 | _loc8_ >>> 4);
            _loc6_ ^= param1[_loc9_ * 4 + 2];
            _loc10_ = uint(SP7[_loc6_ & 0x3F]);
            _loc10_ |= SP5[_loc6_ >>> 8 & 0x3F];
            _loc10_ |= SP3[_loc6_ >>> 16 & 0x3F];
            _loc10_ |= SP1[_loc6_ >>> 24 & 0x3F];
