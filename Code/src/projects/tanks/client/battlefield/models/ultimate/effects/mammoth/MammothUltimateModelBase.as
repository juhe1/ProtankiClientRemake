package projects.tanks.client.battlefield.models.ultimate.effects.mammoth
{
   ...
   public class MammothUltimateModelBase extends Model
   {
      ...
      private var _showUltimateUsedId:Long = Long.getLong(772966954,-359243211);
      ...
      protected function initCodecs() : void
      {
         ...
         _loc1_.registerModelConstructorCodec(this.modelId,this._protocol.getCodec(new TypeCodecInfo(MammothUltimateCC,false)));
