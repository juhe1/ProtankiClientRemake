package projects.tanks.client.battlefield.models.ultimate.effects.hunter
{
   ...
   public class HunterUltimateModelBase extends Model
   {
      ...
      private var _showUltimateUsedId:Long = Long.getLong(804842774,2066310835);
      ...
      protected function initCodecs() : void
      {
         ...
         _loc1_.registerModelConstructorCodec(this.modelId,this._protocol.getCodec(new TypeCodecInfo(HunterUltimateCC,false)));
