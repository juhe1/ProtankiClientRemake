package projects.tanks.client.battlefield.models.battle.assault
{
   ...
   public class SetOfAssaultCC
   {
      
      private var _dictionary:Dictionary = new Dictionary();
      
      public function SetOfAssaultCC()
      {
         super();
      }
      
      public function add(param1:AssaultCC) : void
      {
         this._dictionary[param1] = true;
      }
      
      public function contains(param1:AssaultCC) : Boolean
      {
         return this._dictionary[param1];
      }
      
      public function remove(param1:AssaultCC) : Boolean
      {
