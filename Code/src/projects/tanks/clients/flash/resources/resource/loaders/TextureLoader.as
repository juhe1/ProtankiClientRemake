...
{
   import projects.tanks.clients.flash.resources.resource.loaders.events.LoaderEvent;
   import projects.tanks.clients.flash.resources.resource.loaders.events.LoaderProgressEvent;
   ...
   [Event(name="loaderProgress",type="projects.tanks.clients.flash.resources.resource.loaders.events.LoaderProgressEvent")]
   [Event(name="partComplete",type="projects.tanks.clients.flash.resources.resource.loaders.events.LoaderEvent")]
   [Event(name="partOpen",type="projects.tanks.clients.flash.resources.resource.loaders.events.LoaderEvent")]
   ...
   public class TextureLoader extends EventDispatcher
   {
      ...
      private function onPartLoadingProgress(param1:ProgressEvent) : void
      {
         ...
         {
            _loc2_ = this.state == LOADING_DIFFUSE_MAP ? 0 : 1;
