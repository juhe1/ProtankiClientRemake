package alternativa.protocol.impl
{
   ...
   public class OptionalMapCodecHelper
   {
      ...
      public static function encodeNullMap(param1:OptionalMap, param2:ByteArray) : void
      {
         ...
         if(_loc3_ <= 5)
         {
            param2.writeByte(int((_loc4_[0] & 0xFF) >>> 3));
         }
         else if(_loc3_ <= 13)
         {
            param2.writeByte(int(((_loc4_[0] & 0xFF) >>> 3) + INPLACE_MASK_1_BYTES));
            param2.writeByte(((_loc4_[1] & 0xFF) >>> 3) + (_loc4_[0] << 5));
         }
         else if(_loc3_ <= 21)
         {
            param2.writeByte(int(((_loc4_[0] & 0xFF) >>> 3) + INPLACE_MASK_2_BYTES));
            param2.writeByte(int(((_loc4_[1] & 0xFF) >>> 3) + (_loc4_[0] << 5)));
            param2.writeByte(int(((_loc4_[2] & 0xFF) >>> 3) + (_loc4_[1] << 5)));
         }
         else if(_loc3_ <= 29)
         {
            param2.writeByte(int(((_loc4_[0] & 0xFF) >>> 3) + INPLACE_MASK_3_BYTES));
            param2.writeByte(int(((_loc4_[1] & 0xFF) >>> 3) + (_loc4_[0] << 5)));
            param2.writeByte(int(((_loc4_[2] & 0xFF) >>> 3) + (_loc4_[1] << 5)));
            param2.writeByte(int(((_loc4_[3] & 0xFF) >>> 3) + (_loc4_[2] << 5)));
         }
         else if(_loc3_ <= 504)
         {
            _loc5_ = (_loc3_ >>> 3) + ((_loc3_ & 7) == 0 ? 0 : 1);
            _loc6_ = int((_loc5_ & 0xFF) + MASK_LENGTH_1_BYTE);
         ...
         else
         {
            ...
            _loc6_ = int((_loc7_ & 0xFF0000) >>> 16);
            _loc8_ = int((_loc7_ & 0xFF00) >>> 8);
            _loc9_ = int(_loc7_ & 0xFF);
            param2.writeByte(_loc6_);
      ...
      public static function decodeNullMap(param1:IDataInput, param2:OptionalMap) : void
      {
         ...
         if(_loc6_)
         {
            ...
            if(_loc8_)
            {
               ...
               _loc4_ = (_loc7_ << 16) + ((_loc10_ & 0xFF) << 8) + (_loc11_ & 0xFF);
            }
            else
            {
               _loc4_ = _loc7_;
         ...
         switch(_loc4_)
         {
            ...
            case 1:
               _loc10_ = int(param1.readByte());
               _loc3_.writeByte(int(_loc7_ + ((_loc10_ & 0xFF) >>> 5)));
            ...
            case 2:
               ...
               _loc11_ = int(param1.readByte());
               _loc3_.writeByte(int(_loc7_ + ((_loc10_ & 0xFF) >>> 5)));
               _loc3_.writeByte(int((_loc10_ << 3) + ((_loc11_ & 0xFF) >>> 5)));
            ...
            case 3:
               ...
               _loc3_.writeByte(int(_loc7_ + ((_loc10_ & 0xFF) >>> 5)));
               _loc3_.writeByte(int((_loc10_ << 3) + ((_loc11_ & 0xFF) >>> 5)));
               _loc3_.writeByte(int((_loc11_ << 3) + ((_loc12_ & 0xFF) >>> 5)));
