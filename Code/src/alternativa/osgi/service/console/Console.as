package alternativa.osgi.service.console
{
   ...
   public class Console implements IConsole
   {
      ...
      private function setVar(param1:FormattedOutput, param2:String, param3:String) : void
      {
         ...
         var _loc4_:ConsoleVar = this.variables[param2];
         if(_loc4_ != null)
         {
            _loc5_ = _loc4_.toString();
            _loc6_ = _loc4_.acceptInput(param3);
            if(_loc6_ == null)
            {
               param1.addText("New value " + _loc4_.toString() + ", old value=" + _loc5_);
               return;
            }
            throw new ConsoleVarChangeError(param2,param3,_loc6_);
         }
      ...
      private function printPage() : void
      {
         ...
         while(_loc2_ < this.numPageLines && Boolean(_loc1_.hasNext()))
         {
