package alternativa.tanks.models.battle.assault
{
   ...
   public class ASFlag implements HidableGraphicObject, Trigger, Renderer
   {
      ...
      public function ASFlag(param1:int, param2:BattleTeam, param3:Vector3, param4:int, param5:int, param6:TextureAnimation, param7:CollisionDetector, param8:IAssaultModel, param9:BattleScene3D)
      {
         super();
         this._id = param1;
      ...
      public function checkTrigger(param1:Body) : void
      {
         ...
         contacts.length = 0;
         this.callback.onFlagTouch(this._id);
      }
