package alternativa.tanks.models.battle.assault
{
   ...
   public class ASFlagBaseTrigger implements Trigger
   {
      ...
      private var asModel:IAssaultModel;
      
      private var inZone:Boolean;
      
      private var collisionDetector:CollisionDetector;
      
      public function ASFlagBaseTrigger(param1:Vector3, param2:Number, param3:IAssaultModel, param4:CollisionDetector)
      {
         super();
      ...
      public function checkTrigger(param1:Body) : void
      {
         ...
         if(this.inZone)
         {
            ...
            {
               this.inZone = false;
               this.asModel.onLeaveFlagBaseZone();
            }
         }
         else if(_loc6_ <= this.radiusSquared)
         {
            this.inZone = true;
            this.asModel.onEnterFlagBaseZone();
         }
      }
