package alternativa.tanks.models.battle.assault.hud
{
   ...
   public class ASKeyPointHudMarker implements Renderer
   {
      ...
      private var marker:ASMarker;
      
      private var battleService:BattleService;
      
      public function ASKeyPointHudMarker(param1:BattleView, param2:Camera3D, param3:BattleService, param4:Vector3)
      {
         super();
         this.battleView = param1;
         this.camera = param2;
         this.battleService = param3;
         this.marker = new ASMarker(param4);
         this.marker.visible = false;
         param1.addOverlayObject(this.marker);
      }
      ...
      private function updateMarker(param1:Matrix4) : void
      {
         ...
         this.marker.x = int(v.x + this.battleView.getWidth() / 2 - 12);
         this.marker.y = int(v.y + this.battleView.getHeight() / 2 - 12);
      }
      ...
      private function getPointAlpha() : Number
      {
         ...
         direction.normalize();
         _loc4_ = this.battleService.getBattleScene3D().raycast(cameraPosition,direction,this.battleService.getExcludedObjects3D());
      ...
      private function projectToView(param1:Vector3) : void
      {
         ...
         {
            _loc2_ = this.battleView.getDiagonalSquared();
      ...
      {
         switch(this.battleView.getScreenSize())
         {
      ...
      {
         var _loc5_:Number = this.battleView.getWidth() / 2 - param3;
         var _loc6_:Number = this.battleView.getHeight() / 2 - param4;
