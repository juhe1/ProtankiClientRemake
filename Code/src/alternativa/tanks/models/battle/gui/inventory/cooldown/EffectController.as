package alternativa.tanks.models.battle.gui.inventory.cooldown
{
   ...
   public class EffectController
   {
      ...
      public function EffectController(param1:int, param2:InventoryIcons, param3:CooldownIndicator, param4:ISplashController, param5:Function, param6:Function)
      {
         super();
      ...
      public function update(param1:int) : void
      {
         ...
         else
         {
            ...
            this.lastUpdateTime = param1;
            if(param1 - this._startTime > this._durationTime - this.blinkingPeriod)
            {
