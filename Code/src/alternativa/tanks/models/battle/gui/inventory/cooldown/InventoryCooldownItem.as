package alternativa.tanks.models.battle.gui.inventory.cooldown
{
   ...
   public class InventoryCooldownItem
   {
      ...
      public function InventoryCooldownItem(param1:int, param2:CooldownIndicator, param3:CooldownIndicator, param4:ISplashController, param5:InventoryIcons, param6:Function, param7:Function)
      {
         super();
      ...
      private function init(param1:int, param2:CooldownIndicator, param3:CooldownIndicator, param4:ISplashController) : void
      {
         this._effectController = new EffectController(param1,this._inventoryIcon,param2,param4,this._finishCallBack,this.finishFillEffect);
