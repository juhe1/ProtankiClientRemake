      ...
      private function onTimer(param1:TimerEvent) : void
      {
         ...
         if(this.commands.length > 0)
         {
            if(this.available)
            {
               ...
               if(_loc3_.arguments.length == 1)
               {
                  ExternalInterface.call(_loc3_.command,_loc3_.arguments[0]);
               }
               else
               {
                  ExternalInterface.call(_loc3_.command,_loc3_.arguments[0],_loc3_.arguments[1],_loc3_.arguments[2]);
               }
            }
         }
         else
