package alternativa.tanks.view.battlecreate.slider
{
   ...
   public class SelectRankSlider extends Slider
   {
      ...
      {
         var _loc2_:Boolean = trgt.mouseX < curThumbX;
         var _loc3_:Boolean = trgt.mouseX > curThumbX;
         var _loc4_:Boolean = this._minRang < this._currentRang;
         var _loc5_:Boolean = this._maxRang > this._currentRang;
         var _loc6_:int = 0;
