package alternativa.tanks.controller.commands.partners
{
   ...
   public class CheckCaptchaPartnetsLoginFormCommand extends Command
   {
      ...
      {
         var _loc1_:PartnerLoginEvent = new PartnerLoginEvent(PartnerLoginEvent.LOGIN_AFTER_CAPTCHA_CHECKED,this.event.callsign,this.event.password,this.event.captchaAnswer);
