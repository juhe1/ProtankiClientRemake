package alternativa.tanks.gui.friends.list.dataprovider
{
   ...
   public class FriendsDataProvider extends DataProvider
   {
      ...
      {
         var _loc6_:BattleLinkData = null;
         var _loc3_:IUserInfoLabelUpdater = userInfoService.getOrCreateUpdater(param1);
         var _loc4_:Object = {};
         _loc4_.id = param1;
         _loc4_.uid = _loc3_.uid;
         var _loc5_:int = int(_loc3_.rank);
         _loc4_.rank = _loc5_;
         _loc4_.online = _loc3_.online;
         _loc4_.isNew = friendInfoService.isNewFriend(param1);
         _loc4_.availableInvite = battleInfoService.availableRank(_loc5_);
         _loc4_.isBattle = false;
         _loc4_.availableBattle = false;
         _loc4_.snUid = _loc3_.getSNUid();
         _loc4_.isSNFriend = false;
         _loc4_.isReferral = _loc3_.isReferral();
         if(_loc3_.hasBattleLink())
         {
            _loc6_ = _loc3_.battleLink;
            _loc4_.isBattle = _loc6_.isShowBattle();
            _loc4_.availableBattle = _loc6_.availableRank();
         }
         super.addItem(_loc4_);
         this._store[param1] = _loc4_;
         if(param2)
         {
            this.refresh();
         }
      ...
      public function getItemIndexByProperty(param1:String, param2:*, param3:Boolean = false) : int
      {
         ...
         var _loc5_:int = int(this.length);
         var _loc6_:int = 0;
         while(_loc6_ < _loc5_)
         {
