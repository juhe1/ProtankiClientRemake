package alternativa.tanks.help
{
   ...
   public class RankBarHelper extends PanelBubbleHelper
   {
      ...
      public function RankBarHelper(param1:Number, param2:Number, param3:Number)
      {
         ...
         text = _loc4_.getText(TanksLocale.TEXT_HELP_PANEL_RANK_BAR_HELPER_TEXT);
         arrowLehgth = int(_loc4_.getText(TanksLocale.TEXT_HELP_PANEL_RANK_BAR_HELPER_ARROW_LENGTH));
