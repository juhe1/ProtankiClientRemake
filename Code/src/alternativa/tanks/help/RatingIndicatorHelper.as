package alternativa.tanks.help
{
   ...
   public class RatingIndicatorHelper extends PanelBubbleHelper
   {
      ...
      public function RatingIndicatorHelper(param1:Number, param2:Number, param3:Number)
      {
         ...
         text = _loc4_.getText(TanksLocale.TEXT_HELP_PANEL_RATING_INDICATOR_HELPER_TEXT);
         arrowLehgth = int(_loc4_.getText(TanksLocale.TEXT_HELP_PANEL_RATING_INDICATOR_HELPER_ARROW_LENGTH));
